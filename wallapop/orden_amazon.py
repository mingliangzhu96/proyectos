...
chrome_command = [
    ...
    "--user-data-dir=C:\\Users\\ming\\AppData\\Local\\Google\\Chrome\\User Data\\Profile 8"
]
...
try:
    ...
    # Preparar el archivo CSV para guardar los datos
    with open('pedidos_amazon.csv', 'w', newline='', encoding='utf-8') as csvfile:
        fieldnames = ['Número de pedido', 'Nombre del producto']
        ...
        for order in orders:
            ...
            try:
                ...
                for product in product_elements:
                    ...
                    # Truncar el nombre del producto a 15 caracteres si es demasiado largo
                    if len(product_name) > 20:
                        product_name = product_name[:20] + '...'  # Añadir '...' para indicar truncamiento
                    
                    # Guardar los datos en el archivo CSV
                    writer.writerow({'Número de pedido': order_number, 'Nombre del producto': product_name})
